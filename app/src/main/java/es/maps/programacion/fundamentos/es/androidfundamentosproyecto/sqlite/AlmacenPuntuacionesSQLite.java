...
db.execSQL("CREATE TABLE "divisas" ("ID_DIVISA"  PRIMARY KEY  NOT NULL  UNIQUE , "ID_DIVISA2" , "DIVISA_ES" , "DIVSA_EN" ));
...
db.execSQL("INSERT INTO "paises" VALUES('ZW','ZWE','Zimbabwe','Zimbabue','ZWL',NULL,NULL));
    ...
    public Vector<Puntuacion> listaPuntuaciones(int cantidad) {
        ...
        try {
            ...
            Toast.makeText(context, "No se pueden listar las puntuaciones. Debe eliminar la base de datos actual manualmente", Toast.LENGTH_SHORT).show();
        }
        return result;
    }
}
