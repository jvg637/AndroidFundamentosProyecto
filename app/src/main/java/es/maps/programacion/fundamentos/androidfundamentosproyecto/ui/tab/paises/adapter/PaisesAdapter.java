package es.maps.programacion.fundamentos.androidfundamentosproyecto.ui.tab.paises.adapter;
...
public class PaisesAdapter extends RecyclerView.Adapter<PaisesAdapter.ViewHolder> {
    ...
    private PaisesDivisasSQLite db;
    ...
    public PaisesAdapter(Context context, Vector<Pais> lista) {
        ...
        db = new PaisesDivisasSQLite(context);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (elem.getDivisas() != null && !elem.getDivisas().isEmpty()) {

            String divisas = elem.getDivisas().replace("-", ", ");

            String txtAuxDiv = "";
            holder.divisas.setText(divisas);

        } else {
            holder.divisas.setText((" " + context.getString(R.string.sinmoneda)));
        }
